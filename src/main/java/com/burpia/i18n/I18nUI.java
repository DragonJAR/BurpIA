...
public final class I18nUI {
    ...
    public static final class Hallazgos {
        ...
        public static String REMEDIACION_ISSUE() {
            return tr(
                    "Revisa los encabezados y el cuerpo de la solicitud HTTP para confirmar la vulnerabilidad. Este hallazgo se guarda automáticamente para que no se pierda al cerrar Burp, pero requiere validación manual. Haz clic derecho en la pestaña de hallazgos para enviar la petición al Repeater o al Intruder, y valida siempre manualmente antes de reportar.",
                    "Review the HTTP request headers and body to confirm the vulnerability. This finding is saved automatically so it is not lost when Burp closes, but it requires manual validation. Right-click on the findings tab to send the request to Repeater or Intruder, and always validate manually before reporting.");
        }

        public static String BACKGROUND_ISSUE() {
            return tr(
                    "Hallazgo reportado desde BurpIA. Requiere validación manual antes de confirmar.",
                    "Finding reported from BurpIA. Manual validation required before confirmation.");
        }

        public static String REMEDIACION_BACKGROUND_ISSUE() {
            return tr(
                    "Verifica siempre los hallazgos con pruebas manuales antes de reportar.",
                    "Always verify findings with manual testing before reporting.");
        }
    ...
    public static final class Tooltips {
        ...
        public static final class Configuracion {
            ...
            public static String SELECCIONAR_AGENTE() {
                return I18nUI.tr("Selecciona el perfil de agente (ej. Droid, Claude Code, Antigravity, Open Code, Grok, Codex) a configurar.",
                        "Select the agent profile (e.g. Droid, Claude Code, Antigravity, Open Code, Grok, Codex) to configure.");
            }

            public static String BINARIO_AGENTE() {
                return I18nUI.tr(
                        "Ruta o comando del agente (ej. droid, claude --dangerously-skip-permissions, opencode, agy, codex --yolo, grok).",
                        "Agent path or command (e.g. droid, claude --dangerously-skip-permissions, opencode, agy, codex --yolo, grok).");
            }
